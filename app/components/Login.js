            ...
            <div className="group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="appearance-none rounded-lg block w-full pl-10 pr-3 py-2.5 border border-[#3A3D56] placeholder-[#3A3D56] text-[#EAEAEA] bg-[#1E1E2E]/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4CAF50] focus:border-[#4CAF50] transition-all duration-200 hover:border-[#4CAF50]/50 sm:text-sm"
